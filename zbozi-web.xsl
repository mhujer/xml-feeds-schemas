                ...
                <div id="content">
                    ...
                    <xsl:for-each select="zbozi:SHOPITEM">
                        <div class="product">
                            ...
                            <p class="price-second"><xsl:value-of select="zbozi:PRICE"/>&nbsp;Kč bez
                                DPH (sazba DPH: <xsl:value-of select="zbozi:VAT"/>%) <xsl:if
                            ...
                            <xsl:if
                                test="zbozi:MANUFACTURER and string-length(zbozi:MANUFACTURER) > 0">
                                <p>
                    ...
                    <div class="footer">
                        <hr/>
                        <p>Více informací <a
                                href="http://napoveda.seznam.cz/cz/specifikace-xml.html"
